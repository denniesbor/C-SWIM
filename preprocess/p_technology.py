...
if __name__ == "__main__":
    ...
    clean_gross_output_file(g_output_dir / 'gross_output.csv', g_output_dir / 'cleaned_gross_output.csv')

    # Create production technology matrices
    A_big, X_big, VA_big, FD_big = create_production_technology(tables_dir / 'use_tables.csv')

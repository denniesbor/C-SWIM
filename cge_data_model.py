...
from cge_model import StdModelDef
...
class SAMDataManager:
    ...
    def get_us_sam(self):
        ...
        # Sam US
        sam_us = pd.read_csv("us_balanced_sam.csv", index_col=0)
    ...
    def prepare_sam_data(self, sam_data, output_name=None):
        ...
        print(f"Created SAM data files in: {data_dir}")
        return data_dir
...
def main():
    ...
    print(f"Running CGE model with {sam_type.upper()} SAM...")

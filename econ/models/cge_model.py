...
class StdModelDef:
    ...
    def model(self):
        ...
        self.m.Td0 = Param(initialize=Td0_init, doc="Direct tax", mutable=True)
        ...
        self.m.Tz0 = Param(
            self.m.i, initialize=Tz0_init, doc="Production tax", mutable=True
        )
        ...
        self.m.Tm0 = Param(
            self.m.i, initialize=Tm0_init, doc="Import tariff", mutable=True
        )
        ...
        self.m.F0 = Param(
            ...
            self.m.i,
            initialize=F0_init,
            doc="The h-th factor input by the i-th firm",
            mutable=True,
        )
        ...
        self.m.Y0 = Param(
            self.m.i, initialize=Y0_init, doc="Composite factor", mutable=True
        )
        ...
        self.m.Z0 = Param(
            self.m.i, initialize=Z0_init, doc="Output of the j-th good", mutable=True
        )
        ...
        self.m.M0 = Param(self.m.i, initialize=M0_init, doc="Imports", mutable=True)
        ...
        self.m.tauz = Param(
            self.m.i, initialize=tauz_init, doc="Production tax rate", mutable=True
        )
        ...
        self.m.taum = Param(
            self.m.i, initialize=taum_init, doc="Import tariff rate", mutable=True
        )
        ...
        self.m.Xg0 = Param(
            self.m.i, initialize=Xg0_init, doc="Government consumption", mutable=True
        )
        ...
        self.m.Xv0 = Param(
            self.m.i, initialize=Xv0_init, doc="Investment demand", mutable=True
        )
        ...
        self.m.E0 = Param(self.m.i, initialize=E0_init, doc="Exports", mutable=True)
        ...
        self.m.Q0 = Param(
            self.m.i, initialize=Q0_init, doc="Armington's composite good", mutable=True
        )
        ...
        self.m.D0 = Param(
            self.m.i, initialize=D0_init, doc="Domestic good", mutable=True
        )
        ...
        self.m.Sp0 = Param(initialize=Sp0_init, doc="Private saving", mutable=True)

        def Sg0_init(model):
            # Sg0 = SAM("INV", "GOV")  # government saving
            return model.sam["INV", "GOV"]

        self.m.Sg0 = Param(initialize=Sg0_init, doc="Government saving", mutable=True)
        ...
        self.m.Sf = Param(
            initialize=Sf_init, doc="Foreign saving in US dollars", mutable=True
        )
        ...
        self.m.sigma = Param(
            self.m.i, initialize=sigma_init, doc="Elasticity of substitution"
        )
        ...
        self.m.psi = Param(
            self.m.i, initialize=psi_init, doc="Elasticity of transformation"
        )
        ...
        self.m.eta = Param(
            self.m.i, initialize=eta_init, doc="Substitution elasticity parameter"
        )
        ...
        self.m.phi = Param(
            self.m.i, initialize=phi_init, doc="Transformation elasticity parameter"
        )
        ...
        self.m.alpha = Param(
            self.m.i, initialize=alpha_init, doc="Share parameter in utility func."
        )
        ...
        def beta_init(model, h, i):
            # make sure we sum NUMBERS, not Pyomo expressions
            denom = sum(value(model.F0[k, i]) for k in model.h)
            if denom <= EPS:  # safe numeric check
                return 0.0
            return value(model.F0[h, i]) / denom
        ...
        self.m.ay = Param(
            self.m.i, initialize=ay_init, doc="Composite factor input req. coeff."
        )
        ...
        self.m.mu = Param(
            self.m.i, initialize=mu_init, doc="Government consumption share"
        )
        ...
        self.m.lambd = Param(
            self.m.i, initialize=lambd_init, doc="Investment demand share"
        )
        ...
        self.m.deltam = Param(
            self.m.i, initialize=deltam_init, doc="Share par. in Armington func."
        )
        ...
        self.m.deltad = Param(
            self.m.i, initialize=deltad_init, doc="Share par. in Armington func."
        )
        ...
        self.m.gamma = Param(
            self.m.i, initialize=gamma_init, doc="Scale par. in Armington func."
        )
        ...
        self.m.xie = Param(
            self.m.i, initialize=xie_init, doc="Share par. in transformation func."
        )
        ...
        self.m.xid = Param(
            self.m.i, initialize=xid_init, doc="Share par. in transformation func."
        )
        ...
        self.m.theta = Param(
            self.m.i, initialize=theta_init, doc="Scale par. in transformation func."
        )
        ...
        self.m.ssp = Param(
            initialize=ssp_init, doc="Average propensity for private saving"
        )
        ...
        self.m.ssg = Param(
            initialize=ssg_init, doc="Average propensity for gov. saving"
        )
        ...
        self.m.taud = Param(initialize=taud_init, doc="Direct tax rate")
        ...
        self.m.Tr0 = Param(
            initialize=Tr0_init, doc="Government transfers to households", mutable=True
        )
        ...
        self.m.Sp = Var(
            initialize=Sp0_init, within=PositiveReals, doc="(Eq Sp var) Private saving"
        )
        ...
        self.m.Td = Var(
            initialize=Td0_init, within=PositiveReals, doc="(Eq Td var) Direct tax"
        )
        ...
        self.m.eqpy = Constraint(
            self.m.i, rule=eqpy_rule, doc="(1) Composite factor aggregation function"
        )
        ...
        def eqF_rule(model, h, i):
            ...
            return model.F[h, i] == (
                model.beta[h, i] * model.py[i] * model.Y[i] / model.pf[h]
            )

        self.m.eqF = Constraint(
            self.m.h, self.m.i, rule=eqF_rule, doc="(2) Factor demand function"
        )
        ...
        self.m.eqX = Constraint(
            self.m.i, self.m.i, rule=eqX_rule, doc="(3) Intermediate demand function"
        )
        ...
        self.m.eqY = Constraint(
            self.m.i, rule=eqY_rule, doc="(4) Composite factor demand function"
        )
        ...
        def eqpzs_rule(model, j):
            ...
            return model.pz[j] == (
                model.ay[j] * model.py[j]
                + sum(model.ax[i, j] * model.pq[i] for i in model.i)
            )

        self.m.eqpzs = Constraint(
            self.m.i, rule=eqpzs_rule, doc="(5) Unit cost function"
        )
        ...
        def eqTd_rule(model):
            ...
            return model.Td == model.taud * sum(
                model.pf[h] * model.FF[h] for h in model.h
            )

        self.m.eqTd = Constraint(rule=eqTd_rule, doc="(6) Direct tax revenue function")
        ...
        self.m.eqTz = Constraint(
            self.m.i, rule=eqTz_rule, doc="(7) Production tax revenue function"
        )
        ...
        self.m.eqTm = Constraint(
            self.m.i, rule=eqTm_rule, doc="(8) Import tariff revenue function"
        )
        ...
        def eqXg_rule(model, i):
            ...
            return model.Xg[i] == (
                model.mu[i] * remaining_for_consumption / model.pq[i]
            )

        self.m.eqXg = Constraint(
            self.m.i, rule=eqXg_rule, doc="(9) Government demand function"
        )
        ...
        self.m.eqXv = Constraint(
            self.m.i, rule=eqXv_rule, doc="(10) Investment demand function"
        )
        ...
        def eqSp_rule(model):
            ...
            return model.Sp == model.ssp * sum(
                model.pf[h] * model.FF[h] for h in model.h
            )

        self.m.eqSp = Constraint(rule=eqSp_rule, doc="(11) Private saving function")
        ...
        self.m.eqSg = Constraint(rule=eqSg_rule, doc="(12) Government saving function")
        ...
        self.m.eqXp = Constraint(
            self.m.i, rule=eqXp_rule, doc="(13) Household demand function"
        )
        ...
        self.m.eqpe = Constraint(
            self.m.i, rule=eqpe_rule, doc="(14) World export price equation"
        )
        ...
        self.m.eqpm = Constraint(
            self.m.i, rule=eqpm_rule, doc="(15) World import price equation"
        )

        # (Eq epsilon)
        def eqepsilon_rule(model):
            # sum(i, pWe[i] * E[i]) + Sf = sum(i, pWm[i] * M[i])  # Balance of payments
            return sum(model.pWe[i] * model.E[i] for i in model.i) + model.Sf == sum(
                model.pWm[i] * model.M[i] for i in model.i
            )

        self.m.eqepsilon = Constraint(
            rule=eqepsilon_rule, doc="(16) Balance of payments"
        )
        ...
        self.m.eqpqs = Constraint(
            self.m.i, rule=eqpqs_rule, doc="(17) Armington's function"
        )
        ...
        self.m.eqM = Constraint(
            self.m.i, rule=eqM_rule, doc="(18) Import demand function"
        )
        ...
        self.m.eqD = Constraint(
            self.m.i, rule=eqD_rule, doc="(19) Domestic good demand function"
        )
        ...
        self.m.eqpzd = Constraint(
            self.m.i, rule=eqpzd_rule, doc="(20) Transformation function"
        )
        ...
        self.m.eqE = Constraint(
            self.m.i, rule=eqE_rule, doc="(21) Export supply function"
        )
        ...
        self.m.eqDs = Constraint(
            self.m.i, rule=eqDs_rule, doc="(22) Domestic good supply function"
        )
        ...
        self.m.eqpqd = Constraint(
            self.m.i, rule=eqpqd_rule, doc="(23) Market clearing for composite good"
        )
        ...
        self.m.eqpf = Constraint(
            self.m.h, rule=eqpf_rule, doc="(24) Factor market clearing condition"
        )
        ...
        self.m.eqTr = Constraint(rule=eqTr_rule, doc="Government transfers")
        ...
        self.m.obj = Objective(
            rule=obj_rule, sense=maximize, doc="Utility function [fictitious]"
        )
